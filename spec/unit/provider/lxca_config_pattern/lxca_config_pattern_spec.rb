...
describe Puppet::Type.type(:lxca_config_pattern).provider(:lxca_config_pattern) do
  ...
  describe 'for ensurable filter_by_id' do
    it 'has id as a parameter' do
      expect { config_pattern.provider.filter_by_id }.to raise_error(Puppet::Error, %r{Attribute id is mandatory for the ensurable filter_by_id})
    end
  end

  describe 'for ensurable export_config_pattern' do
    it 'has id as a parameter' do
      expect { config_pattern.provider.export_config_pattern }.to raise_error(Puppet::Error, %r{Attribute id is mandatory for the ensurable export_config_pattern})
    end
  end

  describe 'for ensurable deploy_config_pattern' do
    it 'has id as a parameter' do
      expect { config_pattern.provider.deploy_config_pattern }.to raise_error(Puppet::Error, %r{Attribute id is mandatory for the ensurable deploy_config_pattern})
    end
  end

  describe 'for ensurable deploy_config_pattern' do
    it 'has endpoints as a parameter' do
      expect { config_pattern_deploy1.provider.deploy_config_pattern }.to raise_error(Puppet::Error, %r{Attribute endpoints is mandatory for the ensurable deploy_config_pattern})
    end
  end

  describe 'for ensurable deploy_config_pattern' do
    it 'has restart as a parameter' do
      expect { config_pattern_deploy2.provider.deploy_config_pattern }.to raise_error(Puppet::Error, %r{Attribute restart is mandatory for the ensurable deploy_config_pattern})
    end
  end

  describe 'for ensurable deploy_config_pattern' do
    it 'has etype as a parameter' do
      expect { config_pattern_deploy3.provider.deploy_config_pattern }.to raise_error(Puppet::Error, %r{Attribute etype is mandatory for the ensurable deploy_config_pattern})
    end
  end

  describe 'for ensurable import_config_pattern' do
    it 'has import_json as a parameter' do
      expect { config_pattern.provider.import_config_pattern }.to raise_error(Puppet::Error, %r{Attribute import_json is mandatory for the ensurable import_config_pattern})
    end
  end
