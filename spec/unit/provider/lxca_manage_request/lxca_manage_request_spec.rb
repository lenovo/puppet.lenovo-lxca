...
describe Puppet::Type.type(:lxca_manage_request).provider(:lxca_manage_request) do
  ...
  describe 'for ensurable manage_discovered_devices' do
    it 'has ip_address as a parameter' do
      expect { manage_request.provider.manage_discovered_devices }.to raise_error(Puppet::Error, %r{Attribute ip_address is mandatory for the ensurable manage_discovered_devices})
    end

    it 'has username as a parameter' do
      expect { manage_request_without_username.provider.manage_discovered_devices }.to raise_error(Puppet::Error, %r{Attribute username is mandatory for the ensurable manage_discovered_devices})
    end

    it 'has password as a parameter' do
      expect { manage_request_without_password.provider.manage_discovered_devices }.to raise_error(Puppet::Error, %r{Attribute password is mandatory for the ensurable manage_discovered_devices})
    end

    it 'has recovery_password as a parameter' do
      expect { manage_request_without_rec_pass.provider.manage_discovered_devices }.to raise_error(Puppet::Error, %r{Attribute recovery_password is mandatory for the ensurable manage_discovered_devices})
    end

    it 'has force as a parameter' do
      expect { manage_request_without_force.provider.manage_discovered_devices }.to raise_error(Puppet::Error, %r{Attribute force is mandatory for the ensurable manage_discovered_devices})
    end
  end

  describe 'for ensurable manage_discovered_devices' do
    it 'ensures the request to have been made' do
  ...
  describe 'for ensurable fetch_manage_request' do
    it 'has job_id as a parameter' do
      expect { manage_request.provider.fetch_manage_request }.to raise_error(Puppet::Error, %r{Attribute job_id is mandatory for the ensurable fetch_manage_request})
    end
  end
