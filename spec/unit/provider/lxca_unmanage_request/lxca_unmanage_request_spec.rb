...
describe Puppet::Type.type(:lxca_unmanage_request).provider(:lxca_unmanage_request) do
  ...
  describe "for ensurable unmanage_discovered_devices" do
    it "should have endpoints as a parameter" do
      expect {unmanage_request.provider.unmanage_discovered_devices}.to raise_error(Puppet::Error, /Attribute endpoints is mandatory for the ensurable unmanage_discovered_devices/)
    end

    it "should have force as a parameter" do
      expect {unmanage_request_without_force.provider.unmanage_discovered_devices}.to raise_error(Puppet::Error, /Attribute force is mandatory for the ensurable unmanage_discovered_devices/)
    end
  end
  ...
  describe "for ensurable fetch_unmanage_request" do
    it "should have job_id as a parameter" do
      expect {unmanage_request.provider.fetch_unmanage_request}.to raise_error(Puppet::Error, /Attribute job_id is mandatory for the ensurable fetch_unmanage_request/)
    end
  end
